...
const module6Source = ['fc-2026-modulo-6-financiamiento-apalancamiento']
const addModule6Source = (code: string) => {
  const item = units.flatMap((unit) => unit.topics).find((candidate) => candidate.code === code)
  if (!item) throw new Error(`No se encontró el tema ${code}`)
  item.status = 'sourced'
  if (!item.evidence.sourceIds.includes(module6Source[0])) item.evidence.sourceIds.push(module6Source[0])
  item.pendingNotes = ['Contenido respaldado por la presentación docente de la Unidad 6. Pendiente de ejercicios adicionales, contraste con exámenes y aprobación del usuario.']
  return item
}

const topic61 = addModule6Source('6.1')
topic61.theory = [
  { id: 'theory-6-1-evaluacion', heading: 'Evaluación de fuentes', sourceIds: module6Source, preliminary: true, markdown: `Las fuentes se evalúan mediante flujos descontados: la TIR del flujo de deuda determina su costo efectivo y el VPN permite comparar alternativas. El análisis debe incluir intereses, amortizaciones, comisiones, gastos, apoyos en cuenta, moneda y efectos fiscales.` },
  { id: 'theory-6-1-portafolio', heading: 'Portafolio de financiamiento', sourceIds: module6Source, preliminary: true, markdown: `La decisión se toma en un contexto de portafolio de fuentes y busca minimizar costo para un nivel de riesgo dado. Deben considerarse simultáneamente costo, exposición, moneda, plazo y reversibilidad; inversión y financiamiento se condicionan entre sí.` }
]
topic61.questions = [{ id: 'question-6-1-01', type: 'multiple-choice', prompt: '¿Qué representa la TIR del flujo de una deuda desde el punto de vista del deudor?', options: ['Su costo efectivo','El valor contable del activo','La utilidad operativa'], correctAnswer: 'Su costo efectivo', explanation: 'Se calcula sobre todos los cobros y pagos atribuibles a la fuente.', sourceIds: module6Source }]

const topic62 = addModule6Source('6.2')
topic62.theory = [
  { id: 'theory-6-2-operativo', heading: 'Leverage operativo', sourceIds: module6Source, preliminary: true, markdown: `Mide la variación porcentual de GAII o MON ante cambios porcentuales de ventas. Aumenta con la proporción de costos fijos y cerca del punto de equilibrio; una cifra mayor implica mayor exposición del resultado operativo al volumen.` },
  { id: 'theory-6-2-financiero', heading: 'Leverage financiero', sourceIds: module6Source, preliminary: true, markdown: `Mide la variación porcentual del resultado neto ante cambios porcentuales de GAII. Los intereses fijos amplifican el efecto favorable o adverso y su interpretación supone estructura de costos y financiera constantes para el nivel analizado.` },
  { id: 'theory-6-2-combinado', heading: 'Leverage combinado', sourceIds: module6Source, preliminary: true, markdown: `Relaciona cambios porcentuales de ventas con resultado neto y reúne exposición operativa y financiera. LO, LF y LC son indicadores locales para un nivel de actividad; no son medidas probabilísticas de riesgo.` },
  { id: 'theory-6-2-efecto', heading: 'Efecto leverage sobre ROE', sourceIds: module6Source, preliminary: true, markdown: `El endeudamiento aumenta el ROE cuando el ROA antes de impuestos supera el costo de deuda, lo reduce cuando es inferior y resulta neutro cuando ambos coinciden, condicionado a los supuestos. La magnitud depende del diferencial ROA-costo, de D/FP y del impuesto. Aumentar ROE no basta para concluir creación de valor: debe contrastarse con el costo de fondos propios y el CPC.` }
]
topic62.formulas = [
  { id: 'formula-leverage-operativo-01', name: 'Leverage operativo', expression: 'LO = Margen de contribución total / GAII', variables: [{ symbol: 'LO', name: 'Leverage operativo', definition: 'Sensibilidad de GAII a ventas.' }, { symbol: 'Margen de contribución total', name: 'Ventas menos costos variables', definition: 'Aporte a costos fijos y resultado.' }, { symbol: 'GAII', name: 'Resultado operativo', definition: 'Ganancia antes de intereses e impuestos.' }], assumptions: ['Se evalúa para un nivel de ventas y estructura de costos determinados.'], interpretation: 'Cambio porcentual de GAII por cambio porcentual de ventas.', sourceIds: module6Source },
  { id: 'formula-leverage-financiero-01', name: 'Leverage financiero', expression: 'LF = GAII / (GAII - Intereses)', variables: [{ symbol: 'LF', name: 'Leverage financiero', definition: 'Sensibilidad del resultado neto a GAII.' }, { symbol: 'GAII', name: 'Resultado operativo', definition: 'Ganancia antes de intereses e impuestos.' }, { symbol: 'Intereses', name: 'Costo financiero fijo', definition: 'Intereses del nivel de deuda.' }], assumptions: ['La estructura financiera y la tasa fiscal permanecen constantes.'], interpretation: 'Amplificación producida por intereses fijos.', sourceIds: module6Source },
  { id: 'formula-leverage-combinado-01', name: 'Leverage combinado', expression: 'LC = Margen de contribución total / (GAII - Intereses)', variables: [{ symbol: 'LC', name: 'Leverage combinado', definition: 'Sensibilidad del resultado neto a ventas.' }, { symbol: 'Margen de contribución total', name: 'Contribución', definition: 'Ventas menos variables.' }, { symbol: 'GAII', name: 'Resultado operativo', definition: 'Resultado antes de intereses e impuestos.' }, { symbol: 'Intereses', name: 'Costo financiero', definition: 'Cargo fijo por deuda.' }], assumptions: ['Válido para el nivel de ventas analizado.'], interpretation: 'Combina exposición operativa y financiera.', sourceIds: module6Source },
  { id: 'formula-roe-leverage-01', name: 'ROE con efecto leverage', expression: 'ROE = ROA(1-t) + (ROA-r)(1-t) D/FP', variables: [{ symbol: 'ROE', name: 'Rentabilidad patrimonial', definition: 'Resultado neto sobre fondos propios.' }, { symbol: 'ROA', name: 'Rentabilidad de activos', definition: 'GAII sobre activos antes de impuestos.' }, { symbol: 'r', name: 'Costo de deuda', definition: 'Tasa de interés efectiva usada en el planteo.' }, { symbol: 't', name: 'Impuesto', definition: 'Tasa sobre resultados.' }, { symbol: 'D', name: 'Deuda', definition: 'Fondos de terceros.' }, { symbol: 'FP', name: 'Fondos propios', definition: 'Patrimonio financiador.' }], assumptions: ['Activos = deuda + fondos propios y el tratamiento fiscal es aplicable.'], interpretation: 'Separa retorno del activo y amplificación por deuda.', sourceIds: module6Source }
]
topic62.questions = [{ id: 'question-6-2-01', type: 'multiple-choice', prompt: '¿Son LO, LF y LC medidas completas del riesgo?', options: ['No, miden exposición y no incorporan probabilidades','Sí, siempre','Solo LO'], correctAnswer: 'No, miden exposición y no incorporan probabilidades', explanation: 'La presentación distingue sensibilidad de una medida probabilística.', sourceIds: module6Source }]

const topic63Module6 = addModule6Source('6.3')
topic63Module6.theory.push({ id: 'theory-6-3-flujo-deuda-module6', heading: 'Flujo completo de la deuda', sourceIds: module6Source, preliminary: true, markdown: `El capital recibido debe medirse neto de gastos y apoyos; el servicio incluye intereses, amortizaciones, comisiones, devolución de apoyos y efectos fiscales de IRAE e IP cuando correspondan. El costo es la TIR desde el deudor, no necesariamente la tasa nominal contractual.` })
topic63Module6.formulas.push({ id: 'formula-costo-deuda-tir-01', name: 'Costo efectivo de deuda', expression: '0 = Σ[j=1..n] FFj/(1+kd)^j - FF0', variables: [{ symbol: 'FF0', name: 'Fondos iniciales', definition: 'Capital neto recibido.' }, { symbol: 'FFj', name: 'Servicio de deuda', definition: 'Pagos netos del período j.' }, { symbol: 'kd', name: 'Costo efectivo', definition: 'TIR del flujo del deudor.' }, { symbol: 'n', name: 'Plazo', definition: 'Cantidad de períodos.' }], assumptions: ['Todos los efectos atribuibles se incorporan con signo y fecha correctos.'], interpretation: 'Iguala fondos recibidos y valor presente del servicio.', sourceIds: module6Source })

const topic65Module6 = addModule6Source('6.5')
topic65Module6.theory.push({ id: 'theory-6-5-valor-module6', heading: 'CPC y creación de valor', sourceIds: module6Source, preliminary: true, markdown: `El CPC pondera costo de deuda después de impuestos y costo de fondos propios. Comparar ROA después de impuestos con CPC indica si los activos superan el costo conjunto de financiamiento; la conclusión requiere tasas y bases coherentes.` })

const module71Source = ['fc-2026-modulo-7-1-estructura']
const module72Source = ['fc-2026-modulo-7-2-modelos']
const module8DividendSource = ['fc-2026-modulo-8-dividendos']
const addModule7Source = (code: string, sourceIds: string[]) => {
  const item = units.flatMap((unit) => unit.topics).find((candidate) => candidate.code === code)
  if (!item) throw new Error(`No se encontró el tema ${code}`)
  item.status = 'sourced'
  for (const sourceId of sourceIds) if (!item.evidence.sourceIds.includes(sourceId)) item.evidence.sourceIds.push(sourceId)
  item.pendingNotes = ['Contenido respaldado por materiales docentes de estructura financiera. Pendiente de práctica adicional, contraste con exámenes y aprobación del usuario.']
  return item
}

const topic71 = addModule7Source('7.1', module71Source)
topic71.theory = [
  { id: 'theory-7-1-perfectos', heading: 'Mercados perfectos', sourceIds: module71Source, preliminary: true, markdown: `Todos acceden a información relevante; ningún participante altera precios; los activos son divisibles y comercializables; no hay costos de transacción ni información. Bajo estas condiciones, las decisiones financieras tienen VPN cero.` },
  { id: 'theory-7-1-eficiencia', heading: 'Eficiencia informacional', sourceIds: module71Source, preliminary: true, markdown: `En un mercado eficiente los precios reflejan la información disponible. La forma débil incorpora precios pasados; la semifuerte, información pública; la fuerte, toda información pública y privada. Una respuesta eficiente ajusta inmediatamente; también pueden observarse ajuste demorado o sobrerreacción.` },
  { id: 'theory-7-1-vpn', heading: 'Fuentes financieras con VPN', sourceIds: module71Source, preliminary: true, markdown: `Pueden aparecer VPN positivos por subsidios, tratamientos fiscales, cambios inesperados de precios relativos o menores costos de agencia y bancarrota. El VPN de una deuda se obtiene descontando su servicio a la tasa alternativa habitual, no a la tasa subsidiada del contrato.` }
]

const topic72Module7 = addModule7Source('7.2', module71Source)
topic72Module7.theory.push({ id: 'theory-7-2-estructura-valor', heading: 'Estructura financiera y valor', sourceIds: module71Source, preliminary: true, markdown: `La estructura financiera es la mezcla de deuda y fondos propios. Las teorías estudian si cambiar D/FP modifica el CPC y el valor de mercado total; existe relación inversa entre costo de capital y valor, pero el nivel óptimo depende de negocio, activos, instituciones y generación interna.` })

const topic73 = addModule7Source('7.3', module71Source)
topic73.theory = [
  { id: 'theory-7-3-mm1958', heading: 'M&M sin impuestos', sourceIds: module71Source, preliminary: true, markdown: `Con mercados perfectos y sin impuestos, empresas con igual resultado operativo y riesgo valen lo mismo cualquiera sea su estructura: el endeudamiento personal y corporativo son replicables. El CPC depende del riesgo operativo y permanece constante; el costo patrimonial aumenta linealmente con D/FP, compensando la deuda más barata.` },
  { id: 'theory-7-3-mm1963', heading: 'M&M con impuestos corporativos', sourceIds: module71Source, preliminary: true, markdown: `Al admitir deducibilidad de intereses, la deuda crea un escudo fiscal: el valor apalancado es el valor sin deuda más el valor de la protección. En el marco extremo sin otros costos, mayor deuda aumenta valor, conclusión que luego limita la teoría del trade-off.` },
  { id: 'theory-7-3-arbitraje', heading: 'Arbitraje y replicación', sourceIds: module71Source, preliminary: true, markdown: `Si dos firmas equivalentes difirieran de valor solo por financiamiento, inversores podrían replicar o neutralizar el apalancamiento y arbitrar la diferencia. Este mecanismo sustenta la irrelevancia bajo los supuestos, no fuera de ellos.` }
]
topic73.formulas = [
  { id: 'formula-mm1-sin-impuestos-01', name: 'M&M I sin impuestos', expression: 'V = FP + D = GAI / (R/A)', variables: [{ symbol: 'V', name: 'Valor de firma', definition: 'Valor de mercado de deuda y patrimonio.' }, { symbol: 'FP', name: 'Fondos propios', definition: 'Valor de mercado patrimonial.' }, { symbol: 'D', name: 'Deuda', definition: 'Valor de mercado de deuda.' }, { symbol: 'GAI', name: 'Ganancia operativa esperada', definition: 'Resultado antes de intereses.' }, { symbol: 'R/A', name: 'Rentabilidad de activos', definition: 'Tasa de capitalización operativa.' }], assumptions: ['Mercados perfectos y ausencia de impuestos.'], interpretation: 'El valor depende de activos y riesgo operativo, no de D/FP.', sourceIds: module71Source },
  { id: 'formula-mm2-sin-impuestos-01', name: 'M&M II sin impuestos', expression: 'ke = R/A + (R/A - kd) D/FP', variables: [{ symbol: 'ke', name: 'Costo patrimonial', definition: 'TRR de fondos propios.' }, { symbol: 'R/A', name: 'Costo de activos', definition: 'Rentabilidad exigida al negocio.' }, { symbol: 'kd', name: 'Costo de deuda', definition: 'Tasa de terceros.' }, { symbol: 'D/FP', name: 'Apalancamiento', definition: 'Deuda sobre fondos propios.' }], assumptions: ['Se mantienen supuestos de M&M 1958.'], interpretation: 'El costo patrimonial aumenta con el apalancamiento.', sourceIds: module71Source },
  { id: 'formula-mm1-impuestos-01', name: 'M&M I con impuestos', expression: 'VL = VU + tD', variables: [{ symbol: 'VL', name: 'Firma apalancada', definition: 'Valor con deuda.' }, { symbol: 'VU', name: 'Firma sin deuda', definition: 'Valor no apalancado.' }, { symbol: 't', name: 'Tasa fiscal', definition: 'Impuesto corporativo.' }, { symbol: 'D', name: 'Deuda', definition: 'Monto con escudo fiscal.' }], assumptions: ['Deuda perpetua y escudo utilizable en el planteo simplificado.'], interpretation: 'La deuda agrega el valor presente del escudo fiscal.', sourceIds: module71Source }
]
topic73.questions = [{ id: 'question-7-3-01', type: 'multiple-choice', prompt: '¿Por qué permanece constante el CPC en M&M 1958?', options: ['Porque el aumento de ke compensa la deuda más barata','Porque ke nunca cambia','Porque no existe riesgo operativo'], correctAnswer: 'Porque el aumento de ke compensa la deuda más barata', explanation: 'El apalancamiento traslada riesgo a los accionistas.', sourceIds: module71Source }]

const topic74Module7 = addModule7Source('7.4', module71Source)
topic74Module7.theory.push(
  { id: 'theory-7-4-tradeoff', heading: 'Trade-off e imperfecciones', sourceIds: module71Source, preliminary: true, markdown: `La deuda aporta protección fiscal, pero enfrenta límites de deducibilidad, impuestos personales, incertidumbre fiscal, costos directos e indirectos de bancarrota y costos de agencia. El óptimo equilibra beneficios y costos esperados; no coincide necesariamente con máximo endeudamiento.` },
  { id: 'theory-7-4-agencia', heading: 'Agencia, información y señalización', sourceIds: module71Source, preliminary: true, markdown: `Entre accionistas y acreedores pueden surgir sustitución por activos riesgosos, subinversión y beneficios privados; garantías, covenants, monitoreo y primas intentan contenerlos. La deuda puede reducir caja discrecional y conflictos gerente-accionista, pero aumentar los de accionista-acreedor. Emisiones de deuda o acciones pueden transmitir señales bajo información asimétrica, sin que sean infalibles.` }
)

const topic75 = addModule7Source('7.5', module71Source)
topic75.theory = [{ id: 'theory-7-5-tradicional', heading: 'Enfoque tradicional', sourceIds: module71Source, preliminary: true, markdown: `Durand propone una combinación única que minimiza CPC y maximiza valor. Inicialmente, sustituir fondos propios por deuda más barata reduce CPC; superado un umbral, acreedores y accionistas elevan sus tasas por riesgo, generando el mínimo. Es una teoría distinta de la irrelevancia de M&M.` }]

const topic76 = addModule7Source('7.6', module72Source)
topic76.theory = [{ id: 'theory-7-6-general', heading: 'Modelo General de Financiamiento', sourceIds: module72Source, preliminary: true, markdown: `Clasifica activos por comportamiento financiero: fluctuantes, ligados al ciclo, y permanentes, que incluyen activos fijos y base estable de corrientes. Propone financiar fluctuantes a corto plazo y permanentes a mediano/largo. Financiar permanentes a corto aumenta riesgo y rentabilidad; financiar fluctuantes a largo los reduce.` }]

const topic77 = addModule7Source('7.7', module72Source)
topic77.theory = [{ id: 'theory-7-7-donaldson', heading: 'Modelo de Donaldson', sourceIds: module72Source, preliminary: true, markdown: `Proyecta flujo operativo, inversiones y servicio financiero para distintos niveles de deuda; construye un escenario recesivo y una distribución del flujo operativo; fija una probabilidad tolerable de incumplimiento y selecciona deuda cuyo servicio pueda pagarse. Prioriza solvencia, flexibilidad e inventario de recursos; sus cifras son inciertas y no determina mecánicamente un óptimo único.` }]
topic77.questions = [{ id: 'question-7-7-01', type: 'multiple-choice', prompt: '¿Qué limita principalmente la deuda en Donaldson?', options: ['La capacidad del flujo operativo bajo estrés para pagar el servicio','El valor nominal de las acciones','La media histórica de dividendos'], correctAnswer: 'La capacidad del flujo operativo bajo estrés para pagar el servicio', explanation: 'El modelo confronta servicio y distribución del flujo recesivo.', sourceIds: module72Source }]

const topic78 = addModule7Source('7.8', module72Source)
topic78.theory = [{ id: 'theory-7-8-higgins', heading: 'Crecimiento autosostenido', sourceIds: module72Source, preliminary: true, markdown: `Higgins determina el crecimiento máximo de ventas financiable sin emitir acciones ni alterar endeudamiento. Supone constantes activos/ventas, margen neto, payout y D/FP. Si el crecimiento supera esa tasa, aparecen necesidades externas o debe cambiar alguna política.` }]
topic78.formulas = [{ id: 'formula-crecimiento-sostenible-01', name: 'Crecimiento sostenible por ROE', expression: 'gS = [ROE(1-d)] / [1 - ROE(1-d)]', variables: [{ symbol: 'gS', name: 'Crecimiento sostenible', definition: 'Incremento máximo de ventas bajo supuestos.' }, { symbol: 'ROE', name: 'Rentabilidad patrimonial', definition: 'Resultado neto sobre patrimonio.' }, { symbol: 'd', name: 'Payout', definition: 'Proporción distribuida.' }], assumptions: ['Rentabilidad, payout y apalancamiento permanecen constantes.'], interpretation: 'Crecimiento compatible con NAF cero y estructura estable.', sourceIds: module72Source }]

const topic79 = addModule7Source('7.9', module72Source)
topic79.theory = [{ id: 'theory-7-9-naf', heading: 'Necesidades adicionales de fondos', sourceIds: module72Source, preliminary: true, markdown: `NAF concilia crecimiento de ventas con activos necesarios, pasivos espontáneos y utilidades retenidas. Un resultado positivo es financiamiento adicional requerido. El modelo simplificado supone ratios activos/ventas y pasivos/ventas constantes, margen estable y sensibilidad de los pasivos incluidos.` }]
topic79.formulas = [{ id: 'formula-naf-01', name: 'Necesidades adicionales de fondos', expression: 'NAF = (A/V0)ΔV - (P/V0)ΔV - V1 p(1-d)', variables: [{ symbol: 'NAF', name: 'Necesidad de fondos', definition: 'Financiamiento externo adicional.' }, { symbol: 'A/V0', name: 'Activos sobre ventas', definition: 'Ratio base.' }, { symbol: 'P/V0', name: 'Pasivos sobre ventas', definition: 'Pasivos espontáneos por ventas.' }, { symbol: 'ΔV', name: 'Aumento de ventas', definition: 'Crecimiento proyectado en moneda.' }, { symbol: 'V1', name: 'Ventas proyectadas', definition: 'Ventas del próximo período.' }, { symbol: 'p', name: 'Margen neto', definition: 'Resultado neto sobre ventas.' }, { symbol: 'd', name: 'Payout', definition: 'Fracción distribuida.' }], assumptions: ['Ratios, margen y payout permanecen constantes.'], interpretation: 'Resta financiamiento espontáneo e interno a la inversión incremental.', sourceIds: module72Source }]

const topic710 = addModule7Source('7.10', module8DividendSource)
topic710.theory = [
  { id: 'theory-7-10-politica', heading: 'Política de dividendos', sourceIds: module8DividendSource, preliminary: true, markdown: `Es la mezcla entre utilidad retenida y distribuida, expresada como monto por acción, porcentaje de utilidad o rendimiento sobre precio. Debe compatibilizar inversiones con VPN positivo, estructura de deuda y necesidades de liquidez; beneficios y proyectos, no la mera distribución, son la fuente última del valor.` },
  { id: 'theory-7-10-irrelevancia', heading: 'Irrelevancia y levantamiento de supuestos', sourceIds: module8DividendSource, preliminary: true, markdown: `M&M sostiene irrelevancia si beneficios e inversiones no cambian, mercados son eficientes, no hay costos, dividendos y ganancias de capital tributan igual y no hay señalización. Al levantar supuestos aparecen costos de transacción, impuestos, clientelas, información, agencia y efectos sobre inversión; entonces la política puede afectar valor.` },
  { id: 'theory-7-10-recompras', heading: 'Señales y recompras', sourceIds: module8DividendSource, preliminary: true, markdown: `Cambios de dividendos pueden señalar expectativas de caja. Recomprar acciones es más flexible y puede compensar dilución o aprovechar subvaluación, pero algunos accionistas prefieren la certeza y transparencia del dividendo. Ninguna señal garantiza por sí sola información verdadera.` },
  { id: 'theory-7-10-factores', heading: 'Factores y políticas', sourceIds: module8DividendSource, preliminary: true, markdown: `Influyen restricciones legales y contractuales, liquidez, vencimientos, crecimiento, rentabilidad, estabilidad, acceso a mercados, control, impuestos y oportunidades de inversión. Las políticas pueden ser estables o residuales. Una residual de largo plazo planifica inversiones, generación interna y estructura objetivo para sostener dividendos relativamente estables en el corto plazo.` },
  { id: 'theory-7-10-cautela-legal', heading: 'Cautela sobre normativa', sourceIds: module8DividendSource, preliminary: true, markdown: `La presentación menciona como ejemplo un dividendo mínimo bajo la Ley 16.060. Esta referencia requiere verificación jurídica vigente y no se presenta como asesoramiento ni regla automáticamente aplicable a toda entidad.` }
]
topic710.formulas = [{ id: 'formula-crecimiento-retencion-01', name: 'Crecimiento por retención', expression: 'g = ROE(1-d)', variables: [{ symbol: 'g', name: 'Crecimiento', definition: 'Tasa sostenible simplificada de dividendos/valor.' }, { symbol: 'ROE', name: 'Rentabilidad patrimonial', definition: 'Retorno sobre fondos propios.' }, { symbol: 'd', name: 'Payout', definition: 'Proporción de utilidad distribuida.' }], assumptions: ['ROE y payout se mantienen y la retención se reinvierte.'], interpretation: 'Mayor distribución reduce la retención y el crecimiento, ceteris paribus.', sourceIds: module8DividendSource }]
topic710.questions = [{ id: 'question-7-10-01', type: 'multiple-choice', prompt: '¿Qué debe preservarse antes de aumentar dividendos bajo una política residual?', options: ['Inversiones convenientes y estructura financiera objetivo','Solo el dividendo del último año','Únicamente el precio contable'], correctAnswer: 'Inversiones convenientes y estructura financiera objetivo', explanation: 'Los dividendos resultan del excedente tras financiar el plan consistente.', sourceIds: module8DividendSource }]

const derivatives1Source = ['fc-2026-modulo-10-derivados-1']
const derivatives2Source = ['fc-modulo-10-derivados-2']
const addDerivativesSource = (code: string, sourceIds: string[]) => {
  const item = units.flatMap((unit) => unit.topics).find((candidate) => candidate.code === code)
  if (!item) throw new Error(`No se encontró el tema ${code}`)
  item.status = 'sourced'
  for (const sourceId of sourceIds) if (!item.evidence.sourceIds.includes(sourceId)) item.evidence.sourceIds.push(sourceId)
  item.pendingNotes = ['Contenido respaldado por presentaciones docentes de derivados. Pendiente de ejercicios adicionales, contraste con exámenes y aprobación del usuario.']
  return item
}

const topic91 = addDerivativesSource('9.1', derivatives1Source)
topic91.theory = [
  { id: 'theory-9-1-definicion', heading: 'Opciones, derechos y obligaciones', sourceIds: derivatives1Source, preliminary: true, markdown: `Una opción otorga al comprador, a cambio de una prima, el derecho pero no la obligación de comprar —call— o vender —put— un subyacente a un strike. El vendedor recibe la prima y asume la obligación correspondiente. Una europea se ejerce al vencimiento; una americana, hasta el vencimiento.` },
  { id: 'theory-9-1-resultados', heading: 'Resultados al vencimiento', sourceIds: derivatives1Source, preliminary: true, markdown: `El comprador limita su pérdida a la prima. Long call gana por encima de strike más prima y tiene potencial alcista no acotado. Long put protege caídas: su ganancia está limitada por el hecho de que el subyacente no puede caer debajo de cero. Los vendedores reciben como máximo la prima y asumen el resultado opuesto.` },
  { id: 'theory-9-1-valor', heading: 'Valor y paridad', sourceIds: derivatives1Source, preliminary: true, markdown: `La prima combina valor intrínseco y temporal. Influyen spot, strike, tiempo, volatilidad y tasa libre de riesgo. Para call y put europeas con mismo subyacente, strike y vencimiento, la paridad iguala carteras de flujos futuros equivalentes y permite detectar arbitraje bajo sus supuestos.` },
  { id: 'theory-9-1-cautelas', heading: 'Cautelas editoriales', sourceIds: derivatives1Source, preliminary: true, markdown: `La tabla docente describe el beneficio del comprador de put como ilimitado, pero el payoff estándar está acotado cuando el precio del subyacente llega a cero. Además, el punto de equilibrio de una call vendida es strike más prima. Estas diferencias quedan señaladas y requieren confirmación docente.` }
]
topic91.formulas = [
  { id: 'formula-payoff-call-long-01', name: 'Resultado de call comprada', expression: 'Resultado = max(S-K, 0) - prima', variables: [{ symbol: 'S', name: 'Spot al vencimiento', definition: 'Precio del subyacente al ejercicio.' }, { symbol: 'K', name: 'Strike', definition: 'Precio de ejercicio.' }, { symbol: 'prima', name: 'Prima', definition: 'Precio pagado por el derecho.' }], assumptions: ['Posición mantenida al vencimiento y sin costos adicionales.'], interpretation: 'Pérdida limitada a prima; equilibrio en K más prima.', sourceIds: derivatives1Source },
  { id: 'formula-payoff-put-long-01', name: 'Resultado de put comprada', expression: 'Resultado = max(K-S, 0) - prima', variables: [{ symbol: 'S', name: 'Spot al vencimiento', definition: 'Precio del subyacente.' }, { symbol: 'K', name: 'Strike', definition: 'Precio de venta pactado.' }, { symbol: 'prima', name: 'Prima', definition: 'Precio de la opción.' }], assumptions: ['El subyacente no toma precios negativos.'], interpretation: 'Protege contra caídas; equilibrio en K menos prima.', sourceIds: derivatives1Source },
  { id: 'formula-paridad-call-put-01', name: 'Paridad call-put', expression: 'C + VP(K) = P + S', variables: [{ symbol: 'C', name: 'Call', definition: 'Precio de call europea.' }, { symbol: 'P', name: 'Put', definition: 'Precio de put europea.' }, { symbol: 'S', name: 'Spot', definition: 'Precio actual del subyacente.' }, { symbol: 'VP(K)', name: 'Strike descontado', definition: 'Valor presente del precio de ejercicio.' }], assumptions: ['Opciones europeas, mismo K y vencimiento, sin costos ni restricciones relevantes de venta corta.'], interpretation: 'Carteras con mismo flujo futuro tienen igual valor.', sourceIds: derivatives1Source }
]
topic91.questions = [{ id: 'question-9-1-01', type: 'multiple-choice', prompt: '¿Cuál es la pérdida máxima de quien compra una opción?', options: ['La prima pagada','Siempre el strike completo','Es ilimitada'], correctAnswer: 'La prima pagada', explanation: 'Puede no ejercer el derecho.', sourceIds: derivatives1Source }]

const topic92 = addDerivativesSource('9.2', derivatives1Source)
topic92.theory = [
  { id: 'theory-9-2-forward-futuro', heading: 'Forward y futuro', sourceIds: derivatives1Source, preliminary: true, markdown: `Ambos obligan a comprar/vender en fecha futura a precio pactado. El forward es bilateral, a medida, OTC, normalmente liquidado al vencimiento y con riesgo de contraparte. El futuro es estandarizado, negociado en mercado organizado, con cámara, garantías, liquidación diaria y posibilidad de cerrar mediante posición opuesta.` },
  { id: 'theory-9-2-posiciones', heading: 'Posiciones y márgenes', sourceIds: derivatives1Source, preliminary: true, markdown: `La posición larga gana si sube el precio del futuro; la corta, si baja. La cuenta de margen recibe resultados diarios y una caída bajo el mantenimiento puede generar margin call. Al vencimiento, futuro y spot convergen bajo el funcionamiento normal del contrato.` }
]
topic92.formulas = [{ id: 'formula-resultado-futuro-long-01', name: 'Resultado acumulado de futuro largo', expression: 'Resultado = (ST - F0) × cantidad', variables: [{ symbol: 'ST', name: 'Spot/futuro final', definition: 'Precio al vencimiento.' }, { symbol: 'F0', name: 'Precio pactado', definition: 'Precio inicial del futuro.' }, { symbol: 'cantidad', name: 'Tamaño', definition: 'Unidades del subyacente.' }], assumptions: ['Se mantiene la posición y se agregan las liquidaciones diarias.'], interpretation: 'El largo gana cuando el precio final supera el pactado.', sourceIds: derivatives1Source }]

const topic93 = addDerivativesSource('9.3', [...derivatives1Source, ...derivatives2Source])
topic93.theory = [
  { id: 'theory-9-3-conceptos', heading: 'Derivados y subyacentes', sourceIds: derivatives1Source, preliminary: true, markdown: `Un derivado fija hoy términos de una transacción o intercambio futuro y toma valor de un subyacente: commodity, divisa, tasa, acción, deuda o índice. Spot es precio contado; strike, ejercicio; larga es posición comprada; corta, vendida; un NDF liquida diferencias sin entrega.` },
  { id: 'theory-9-3-swaps', heading: 'Swaps', sourceIds: derivatives2Source, preliminary: true, markdown: `Un swap intercambia flujos futuros en fechas y bajo reglas pactadas. Puede verse como sucesión de forwards. En tasa de interés, un nocional sirve para calcular pagos fijo/flotante y suele liquidarse la diferencia sin intercambiar principal. En moneda pueden intercambiarse principal e intereses; un CDS transfiere riesgo de crédito mediante prima y protección.` },
  { id: 'theory-9-3-componentes', heading: 'Componentes y riesgos', sourceIds: derivatives2Source, preliminary: true, markdown: `Se definen contrapartes, principal o nocional, indicador, flujos, plazo, fechas de pago, negociación y vencimiento. Al ser contratos a medida pueden mejorar correspondencia de moneda o tasa, pero enfrentan riesgo de crédito, acceso y costos. La afirmación general “no hay intercambio de principales” no aplica sin matiz a swaps de moneda.` }
]
topic93.questions = [{ id: 'question-9-3-01', type: 'multiple-choice', prompt: '¿Qué se intercambia normalmente en un swap simple de tasa?', options: ['Pagos de interés calculados sobre un nocional','La propiedad definitiva de la empresa','Siempre el principal físico'], correctAnswer: 'Pagos de interés calculados sobre un nocional', explanation: 'El nocional sirve de base y suele liquidarse la diferencia.', sourceIds: derivatives2Source }]

const topic94 = addDerivativesSource('9.4', [...derivatives1Source, ...derivatives2Source])
topic94.theory = [
  { id: 'theory-9-4-usos', heading: 'Cobertura, especulación y arbitraje', sourceIds: derivatives1Source, preliminary: true, markdown: `Cobertura transfiere una exposición no deseada; especulación asume exposición para ganar por variaciones; arbitraje explota inconsistencias de precios. Una cobertura reduce un riesgo específico pero puede introducir base, liquidez, margen, contraparte o costo de oportunidad.` },
  { id: 'theory-9-4-eleccion', heading: 'Elección del instrumento', sourceIds: [...derivatives1Source, ...derivatives2Source], preliminary: true, markdown: `Futuros y forwards fijan bilateralmente un precio y obligan a ambas partes; opciones aseguran un límite preservando un resultado favorable a cambio de prima; swaps transforman perfiles de tasa, moneda o crédito. La posición debe corresponder al riesgo real: por ejemplo, un comprador futuro cubre una suba del insumo y una put comprada cubre una caída del activo.` }
]
topic94.questions = [{ id: 'question-9-4-01', type: 'multiple-choice', prompt: '¿Qué distingue una cobertura de una especulación?', options: ['La cobertura compensa una exposición preexistente','La cobertura garantiza ganancias','La especulación elimina todo riesgo'], correctAnswer: 'La cobertura compensa una exposición preexistente', explanation: 'Su objetivo es reducir un riesgo no deseado, no generar certeza total.', sourceIds: derivatives1Source }]

const shortTermSource = ['fc-2026-modulo-9-finanzas-corto-plazo']
const addShortTermSource = (code: string) => {
  const item = units.flatMap((unit) => unit.topics).find((candidate) => candidate.code === code)
  if (!item) throw new Error(`No se encontró el tema ${code}`)
  item.status = 'sourced'
  if (!item.evidence.sourceIds.includes(shortTermSource[0])) item.evidence.sourceIds.push(shortTermSource[0])
  item.pendingNotes = ['Contenido respaldado por la presentación docente de Finanzas de corto plazo. Pendiente de práctica adicional, contraste con exámenes y aprobación del usuario.']
  return item
}

const topic81 = addShortTermSource('8.1')
topic81.theory = [
  { id: 'theory-8-1-definiciones', heading: 'Capital de trabajo: dos perspectivas', sourceIds: shortTermSource, preliminary: true, markdown: `La definición contable usa capital de trabajo neto: activos corrientes menos pasivos corrientes. La perspectiva financiera presentada mide la inversión operativa como activos corrientes menos pasivos espontáneos y excluye deuda financiera de corto plazo. No deben confundirse: responden a preguntas diferentes.` },
  { id: 'theory-8-1-componentes', heading: 'Componentes y comportamiento', sourceIds: shortTermSource, preliminary: true, markdown: `Los activos corrientes incluyen caja, inversiones temporarias, cuentas por cobrar e inventarios; los pasivos corrientes incluyen proveedores, gastos acumulados y obligaciones exigibles en el año. Una base de activos corrientes es permanente y otra fluctúa con estacionalidad o ciclo. Tienen vida corta, renovación constante, divisibilidad y alta sensibilidad a ventas.` },
  { id: 'theory-8-1-ciclos', heading: 'Ciclo operativo y ciclo de caja', sourceIds: shortTermSource, preliminary: true, markdown: `El ciclo operativo va desde la compra de insumos hasta el cobro al cliente. Los proveedores financian una parte; el ciclo de conversión de caja es el período restante que debe financiar la empresa. Se compone de días de inventario más días de cobro menos días de pago.` },
  { id: 'theory-8-1-factores', heading: 'Factores determinantes y coordinación', sourceIds: shortTermSource, preliminary: true, markdown: `El capital requerido depende de ventas, crecimiento, aversión al riesgo, negocio, proceso productivo, lead time, estacionalidad, rotaciones y plazos de compra/venta. Finanzas busca minimizar inversión; Comercial favorece disponibilidad y crédito; Producción prioriza continuidad y stock. La política exige coordinación entre objetivos.` },
  { id: 'theory-8-1-origenes', heading: 'Orígenes y aplicaciones de efectivo', sourceIds: shortTermSource, preliminary: true, markdown: `Aumentar deuda, patrimonio o pasivos corrientes y vender activos genera efectivo. Amortizar deuda, recomprar acciones, reducir pasivos o aumentar activos lo consume. La clasificación deriva de la identidad del balance y sustenta el análisis de flujos.` }
]
topic81.formulas = [
  { id: 'formula-ctn-01', name: 'Capital de trabajo neto contable', expression: 'CTN = AC - PC', variables: [{ symbol: 'CTN', name: 'Capital de trabajo neto', definition: 'Exceso contable de activos corrientes sobre pasivos corrientes.' }, { symbol: 'AC', name: 'Activos corrientes', definition: 'Activos realizables dentro del ciclo/año contable.' }, { symbol: 'PC', name: 'Pasivos corrientes', definition: 'Obligaciones exigibles en el corto plazo.' }], assumptions: ['La clasificación corriente es homogénea y corresponde a la misma fecha.'], interpretation: 'Mide holgura corriente contable, no liquidez futura por sí sola.', sourceIds: shortTermSource },
  { id: 'formula-ct-financiero-01', name: 'Capital de trabajo financiero', expression: 'CT financiero = AC - Pasivos espontáneos', variables: [{ symbol: 'AC', name: 'Activos corrientes', definition: 'Inversión corriente total.' }, { symbol: 'Pasivos espontáneos', name: 'Financiamiento operativo', definition: 'Proveedores, impuestos, sueldos y gastos que nacen de operar.' }], assumptions: ['La deuda financiera de corto plazo se trata como fuente externa, no espontánea.'], interpretation: 'Aproxima la inversión operativa que debe financiarse explícitamente.', sourceIds: shortTermSource },
  { id: 'formula-cci-01', name: 'Ciclo de conversión de inventario', expression: 'CCI = Inventario promedio / (Costo de ventas / 365)', variables: [{ symbol: 'CCI', name: 'Días de inventario', definition: 'Tiempo promedio inmovilizado en existencias.' }, { symbol: 'Inventario promedio', name: 'Existencias promedio', definition: 'Saldo representativo del período.' }, { symbol: 'Costo de ventas', name: 'Costo anual', definition: 'Flujo anual asociado al inventario vendido.' }], assumptions: ['Año de 365 días y saldos promedio representativos.'], interpretation: 'Mayor CCI implica más días de capital inmovilizado.', sourceIds: shortTermSource },
  { id: 'formula-cccc-01', name: 'Ciclo de conversión de cuentas a cobrar', expression: 'CCCC = Cuentas a cobrar promedio / (Ventas a crédito / 365)', variables: [{ symbol: 'CCCC', name: 'Días de cobro', definition: 'Tiempo medio entre venta y cobro.' }, { symbol: 'Cuentas a cobrar promedio', name: 'Créditos comerciales', definition: 'Saldo promedio de clientes.' }, { symbol: 'Ventas a crédito', name: 'Ventas financiadas', definition: 'Ventas anuales que originan cuentas a cobrar.' }], assumptions: ['Si no se separan ventas a crédito, usar ventas totales es una aproximación documentada.'], interpretation: 'Compara cobranza efectiva con la política comercial.', sourceIds: shortTermSource },
  { id: 'formula-cccp-01', name: 'Ciclo de conversión de cuentas a pagar', expression: 'CCCP = Cuentas a pagar promedio / ((CV + G aplicables) / 365)', variables: [{ symbol: 'CCCP', name: 'Días de pago', definition: 'Plazo medio financiado por proveedores.' }, { symbol: 'Cuentas a pagar promedio', name: 'Pasivo comercial', definition: 'Saldo promedio no financiero.' }, { symbol: 'CV + G aplicables', name: 'Compras/costos financiados', definition: 'Flujo anual que genera las cuentas a pagar.' }], assumptions: ['El denominador debe corresponder a las obligaciones incluidas.'], interpretation: 'Mayor CCCP reduce el período financiado por la empresa, dentro de límites comerciales.', sourceIds: shortTermSource },
  { id: 'formula-ccc-01', name: 'Ciclo de conversión de caja', expression: 'CCC = CCI + CCCC - CCCP', variables: [{ symbol: 'CCC', name: 'Ciclo de caja', definition: 'Días netos que deben financiarse.' }, { symbol: 'CCI', name: 'Inventario', definition: 'Días en existencias.' }, { symbol: 'CCCC', name: 'Cobro', definition: 'Días de clientes.' }, { symbol: 'CCCP', name: 'Pago', definition: 'Días financiados por proveedores.' }], assumptions: ['Ciclos calculados con bases y períodos coherentes.'], interpretation: 'Reducir inventario/cobro o ampliar pago acorta la necesidad financiera.', sourceIds: shortTermSource }
]
topic81.examples = [{ id: 'example-ccc-01', title: 'Ciclo de caja de un negocio', prompt: 'Inventario 2.500, cuentas a cobrar 1.800, cuentas a pagar 875, ventas 11.500 y costo de ventas 8.200.', steps: ['CCI = 2.500 / (8.200/365) = 111,3 días.', 'CCCC = 1.800 / (11.500/365) = 57,1 días.', 'CCCP = 875 / (8.200/365) = 38,9 días.', 'CCC = 111,3 + 57,1 - 38,9.'], result: 'CCC = 129,5 días.', interpretation: 'La empresa debe financiar aproximadamente 129,5 días de operación netos del crédito de proveedores.', sourceIds: shortTermSource }]
topic81.questions = [{ id: 'question-8-1-01', type: 'multiple-choice', prompt: '¿Qué efecto tiene acelerar el cobro, manteniendo lo demás constante?', options: ['Reduce el CCC','Aumenta el CCC','No cambia el financiamiento'], correctAnswer: 'Reduce el CCC', explanation: 'Disminuyen los días de cuentas a cobrar.', sourceIds: shortTermSource }]

const topic82 = addShortTermSource('8.2')
topic82.theory = [
  { id: 'theory-8-2-dimensiones', heading: 'Liquidez y solvencia', sourceIds: shortTermSource, preliminary: true, markdown: `La liquidez combina velocidad, facilidad, certeza de precio y rendimiento al convertir activos en caja. Para la firma es capacidad de cumplir obligaciones en fecha más flexibilidad para oportunidades. Solvencia compara estructuralmente activos y deudas; una empresa solvente puede ser ilíquida.` },
  { id: 'theory-8-2-comportamiento', heading: 'Liquidez normal y problemática', sourceIds: shortTermSource, preliminary: true, markdown: `La liquidez normal proviene de cobros operativos, caja, inversiones de corto plazo y líneas habituales. Ante deterioro, las respuestas crecen en intensidad: administrar cobros/pagos, renegociar acreedores y vender activos no estratégicos, con costos financieros, operativos y reputacionales.` },
  { id: 'theory-8-2-insolvencia', heading: 'Tipos de insolvencia en el material', sourceIds: shortTermSource, preliminary: true, markdown: `La presentación distingue insolvencia técnica por flujo temporal insuficiente; contable cuando pasivos superan activos; económica cuando el valor de mercado de activos no cubre deudas; y de caja cuando el presupuesto proyecta insuficiencia. Es una taxonomía docente y sus categorías pueden solaparse en otros marcos.` },
  { id: 'theory-8-2-alertas', heading: 'Señales de alerta', sourceIds: shortTermSource, preliminary: true, markdown: `Alertas financieras: ratios deteriorados, CCC creciente, cobros más lentos y sobregiros. Operativas: faltantes, demoras a proveedores, mora de clientes e inventario obsoleto. Estratégicas: pérdida de mercado, salida de personal clave y postergación de inversiones. La tendencia importa más que un dato aislado.` },
  { id: 'theory-8-2-ratios', heading: 'Ratios: utilidad y límites', sourceIds: shortTermSource, preliminary: true, markdown: `Los ratios son simples y comparables, pero usan una foto contable, no proyectan caja, ignoran líneas disponibles y pueden manipularse mediante decisiones de cierre. Deben contrastarse con historia, sector, presupuestos y ciclo del efectivo; no existen umbrales universales.` },
  { id: 'theory-8-2-lambda', heading: 'Lambda y brechas', sourceIds: shortTermSource, preliminary: true, markdown: `Lambda expresa reservas líquidas y flujos anticipados en unidades de incertidumbre de caja. La brecha clasifica activos y pasivos por vencimiento, calcula diferencias y acumulados. La presentación no define de modo inequívoco el signo de la brecha; debe declararse la convención antes de interpretarla.` }
]
topic82.formulas = [
  { id: 'formula-razon-corriente-01', name: 'Razón corriente', expression: 'RC = AC / PC', variables: [{ symbol: 'RC', name: 'Razón corriente', definition: 'Activos corrientes por unidad de pasivo corriente.' }, { symbol: 'AC', name: 'Activos corrientes', definition: 'Recursos clasificados a corto plazo.' }, { symbol: 'PC', name: 'Pasivos corrientes', definition: 'Obligaciones de corto plazo.' }], assumptions: ['Clasificación contable coherente y PC distinto de cero.'], interpretation: 'Una cifra alta puede ser holgura o activos ociosos; requiere composición y comparación.', sourceIds: shortTermSource },
  { id: 'formula-prueba-acida-01', name: 'Prueba ácida', expression: 'PA = (AC - Inventarios) / PC', variables: [{ symbol: 'PA', name: 'Prueba ácida', definition: 'Cobertura sin vender inventario.' }, { symbol: 'AC', name: 'Activos corrientes', definition: 'Activos a corto plazo.' }, { symbol: 'Inventarios', name: 'Existencias', definition: 'Componente menos líquido excluido.' }, { symbol: 'PC', name: 'Pasivos corrientes', definition: 'Obligaciones a corto.' }], assumptions: ['Los demás activos corrientes son razonablemente realizables.'], interpretation: 'Mide dependencia del inventario para pagar pasivos.', sourceIds: shortTermSource },
  { id: 'formula-prueba-acida-minima-01', name: 'Prueba ácida mínima', expression: 'PAM = (Caja + Inversiones temporarias) / PC', variables: [{ symbol: 'PAM', name: 'Liquidez inmediata', definition: 'Cobertura con activos inmediatamente líquidos.' }, { symbol: 'Caja', name: 'Disponibilidades', definition: 'Efectivo y equivalentes definidos.' }, { symbol: 'Inversiones temporarias', name: 'Títulos líquidos', definition: 'Inversiones realizables de corto plazo.' }, { symbol: 'PC', name: 'Pasivos corrientes', definition: 'Obligaciones de corto plazo.' }], assumptions: ['Las inversiones son realizables sin pérdida material.'], interpretation: 'Cobertura inmediata, no capacidad total de generar caja.', sourceIds: shortTermSource },
  { id: 'formula-ctn-activos-01', name: 'CTN sobre activos', expression: 'CTN/AT = (AC - PC) / AT', variables: [{ symbol: 'CTN/AT', name: 'Capital corriente relativo', definition: 'CTN normalizado por tamaño.' }, { symbol: 'AT', name: 'Activos totales', definition: 'Base total de activos.' }, { symbol: 'AC', name: 'Activos corrientes', definition: 'Activos a corto.' }, { symbol: 'PC', name: 'Pasivos corrientes', definition: 'Pasivos a corto.' }], assumptions: ['Partidas de una misma fecha.'], interpretation: 'Facilita comparación de empresas de diferente tamaño.', sourceIds: shortTermSource },
  { id: 'formula-lambda-liquidez-01', name: 'Lambda de liquidez', expression: 'λ = (Reserva líquida inicial + Flujos anticipados) / σ(Flujos de caja)', variables: [{ symbol: 'λ', name: 'Lambda', definition: 'Reservas expresadas en desvíos de flujo.' }, { symbol: 'Reserva líquida inicial', name: 'Liquidez inicial', definition: 'Caja y reservas disponibles.' }, { symbol: 'Flujos anticipados', name: 'Caja esperada', definition: 'Flujos proyectados del horizonte.' }, { symbol: 'σ(Flujos de caja)', name: 'Incertidumbre', definition: 'Desvío estándar de los flujos.' }], assumptions: ['Horizonte, distribución y medida de reservas están definidos.'], interpretation: 'Mayor lambda implica mayor colchón frente a variabilidad estimada.', sourceIds: shortTermSource }
]
topic82.examples = [{ id: 'example-liquidez-ratios-01', title: 'Lectura conjunta de ratios de liquidez', prompt: 'AC 8.642, inventarios 5.363, caja 636, PC 3.454 y activos totales 11.635.', steps: ['RC = 8.642/3.454 = 2,50.', 'PA = (8.642-5.363)/3.454 = 0,95.', 'PAM = 636/3.454 = 0,18.', 'CTN/AT = (8.642-3.454)/11.635 = 44,6%.'], result: 'Holgura corriente global, pero alta dependencia de inventarios y baja cobertura inmediata.', interpretation: 'Un ratio aislado puede ocultar la composición de la liquidez. Los colores del semáforo de la diapositiva son inconsistentes con su texto y no se reproducen.', sourceIds: shortTermSource }]
topic82.questions = [{ id: 'question-8-2-01', type: 'multiple-choice', prompt: '¿Puede una empresa solvente ser ilíquida?', options: ['Sí, si no dispone de caja cuando vencen obligaciones','No, nunca','Solo si no tiene inventarios'], correctAnswer: 'Sí, si no dispone de caja cuando vencen obligaciones', explanation: 'Solvencia y liquidez tienen horizontes distintos.', sourceIds: shortTermSource }]

const topic83 = addShortTermSource('8.3')
topic83.theory = [
  { id: 'theory-8-3-optimo', heading: 'Nivel óptimo de activos corrientes', sourceIds: shortTermSource, preliminary: true, markdown: `Mantener activos corrientes genera costo de oportunidad, almacenamiento y obsolescencia; mantener pocos provoca transacciones urgentes, faltantes, ventas perdidas e interrupciones. El óptimo minimiza el costo total y depende del negocio.` },
  { id: 'theory-8-3-politicas', heading: 'Políticas de financiamiento', sourceIds: shortTermSource, preliminary: true, markdown: `Una política flexible usa más financiamiento de largo plazo y liquidez, con menor riesgo y retorno. Una restrictiva usa corto plazo incluso para activos permanentes, con menor costo esperado y mayor refinanciamiento. La moderada calza vencimientos. Aunque la diapositiva dice que en el caso ideal el CTN es siempre cero, financiar activos corrientes permanentes con largo plazo puede generar CTN positivo; la afirmación requiere precisión docente.` },
  { id: 'theory-8-3-espontaneas', heading: 'Fuentes espontáneas', sourceIds: shortTermSource, preliminary: true, markdown: `Proveedores, impuestos, sueldos, cargas y gastos acumulados nacen de la operación y crecen con actividad sin negociación explícita. Reducen la necesidad bancaria, pero demorar pagos más allá de condiciones razonables puede perder descuentos, reputación o suministro.` },
  { id: 'theory-8-3-ccfg', heading: 'Ciclo de Conversión Financiero Global', sourceIds: shortTermSource, preliminary: true, markdown: `El CCFG monetiza la inversión operativa del ciclo: inventario y créditos menos proveedores. El ejemplo informa aproximadamente 4.420, pero los saldos visibles dan 5.363 + 1.732 - 2.714 = 4.381; se conserva la discrepancia para revisión y no se fuerza una conciliación.` },
  { id: 'theory-8-3-caja', heading: 'Gestión de caja', sourceIds: shortTermSource, preliminary: true, markdown: `Se mantiene efectivo por transacción, precaución y especulación. El objetivo es el saldo más bajo compatible con operar y responder a incertidumbre. El costo de oportunidad de caja excedente se equilibra con costos de venta urgente de títulos, crédito de emergencia, incumplimiento y daño comercial.` },
  { id: 'theory-8-3-ratios-contexto', heading: 'Ratios complementarios del material', sourceIds: shortTermSource, preliminary: true, markdown: `La presentación también repasa endeudamiento, actividad, rentabilidad, crecimiento y valuación. Esos conceptos ya se desarrollan en otras unidades; aquí solo se usan como diagnóstico contextual y no se duplican ni modifican sus contenidos. La fórmula Ventas/Activos totales corresponde a rotación de activos totales, aunque la diapositiva la titula rotación de activos fijos.` }
]
topic83.formulas = [{ id: 'formula-ccfg-01', name: 'Ciclo de Conversión Financiero Global', expression: 'CCFG = [CCCC + CCI(CV/V) - CCCP((CV+G)/V)] × (V/365)', variables: [{ symbol: 'CCFG', name: 'Inversión operativa neta', definition: 'Recursos monetarios inmovilizados en el ciclo.' }, { symbol: 'CCCC', name: 'Días de cobro', definition: 'Ciclo de cuentas a cobrar.' }, { symbol: 'CCI', name: 'Días de inventario', definition: 'Ciclo de existencias.' }, { symbol: 'CCCP', name: 'Días de pago', definition: 'Financiamiento de proveedores.' }, { symbol: 'CV', name: 'Costo de ventas', definition: 'Costo anual asociado a inventario.' }, { symbol: 'G', name: 'Gastos aplicables', definition: 'Gastos que originan cuentas a pagar.' }, { symbol: 'V', name: 'Ventas', definition: 'Ventas anuales.' }], assumptions: ['Saldos promedio y flujos anuales corresponden al mismo período.'], interpretation: 'Equivale conceptualmente a inventarios más créditos comerciales menos pasivos comerciales.', sourceIds: shortTermSource }]
topic83.examples = [{ id: 'example-ccc-completo-01', title: 'CCC y capital operativo del caso docente', prompt: 'Inventarios 5.363, cuentas a cobrar 1.732, cuentas a pagar 2.714, ventas 13.107, costo de ventas 10.382 y costos más gastos 12.302.', steps: ['CCI = 188,4 días.', 'CCCC = 48,2 días.', 'CCCP = 80,6 días.', 'CCC = 188,4 + 48,2 - 80,6 = 156,0 días.', 'Capital operativo directo = 5.363 + 1.732 - 2.714.'], result: 'CCC = 156,0 días; capital operativo directo = 4.381.', interpretation: 'El inventario es el principal cuello de botella. La presentación muestra aproximadamente 4.420 para CCFG, diferencia pendiente de aclaración.', sourceIds: shortTermSource }]
topic83.questions = [{ id: 'question-8-3-01', type: 'multiple-choice', prompt: '¿Cuál es el principal riesgo de financiar activos permanentes con deuda de corto plazo?', options: ['Riesgo de refinanciamiento','Eliminar todo costo financiero','Aumentar automáticamente la solvencia'], correctAnswer: 'Riesgo de refinanciamiento', explanation: 'La fuente vence antes de que el activo libere fondos.', sourceIds: shortTermSource }]
