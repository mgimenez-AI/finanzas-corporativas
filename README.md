...
El service worker se genera en el build. La aplicación debe abrirse al menos una vez con conexión para instalarse y precargar sus recursos. El progreso local puede perderse si se borran los datos del navegador y no se sincroniza entre dispositivos.
